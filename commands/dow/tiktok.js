...
⭒̇ㅤ֯◌ 〃 ׄ 〬〿 *Título:* ${title}
⭒̇ㅤ֯◌ 〃 ׄ 〬〿 *Autor:* ${author.nickname || author.unique_id || 'Desconocido'}
⭒̇ㅤ֯◌ 〃 ׄ 〬〿 *Duración:* ${duration || 'N/A'}
⭒̇ㅤ֯◌ 〃 ׄ 〬〿 *Likes:* ${(stats.likes || 0).toLocaleString()}
⭒̇ㅤ֯◌ 〃 ׄ 〬〿 *Comentarios:* ${(stats.comments || 0).toLocaleString()}
⭒̇ㅤ֯◌ 〃 ׄ 〬〿 *Vistas:* ${(stats.views || stats.plays || 0).toLocaleString()}
⭒̇ㅤ֯◌ 〃 ׄ 〬〿 *Compartidos:* ${(stats.shares || 0).toLocaleString()}
⭒̇ㅤ֯◌ 〃 ׄ 〬〿 *Audio:* ${music.title ? music.title + ' -' : 'Desconocido'} ${music.author || ''}`.trim()
